...
def _watch(bot: Bot, update, isTar=False):
    ...
    try:
        ...
        msg += f"\n\nExample :-\n<code>/{BotCommands.WatchCommand} https://youtu.be/RgKAFK5djSk 720 |Freak</code>\n\n"
        msg += "This file will be downloaded in 720p quality and it's name will be <b>Freak</b>"
